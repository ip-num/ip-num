...
import {IPv6} from "./IPnumbers";
import {IPv4} from "./IPnumbers";
...
export abstract class AbstractIpRange<T extends IPv4 | IPv6> implements Iterable<IPv4 | IPv6> {
...
export class Range<T extends IPv4 | IPv6> extends AbstractIpRange<T> {
 ...
 */
export class IPv4CidrRange extends AbstractIpRange<IPv4> {
 ...
 * @see https://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing
 */
export class IPv6CidrRange extends AbstractIpRange<IPv6> {
